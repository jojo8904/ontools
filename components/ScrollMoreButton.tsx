  ...
  return (
    ...
    >
      <button
        type="button"
        onClick={scrollDown}
        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#f97316] text-white text-sm font-bold shadow-[0_6px_16px_rgba(249,115,22,0.45)] hover:bg-[#ea580c] hover:scale-105 transition-all"
      >
        {label}
