...
export const metadata: Metadata = {
  alternates: { canonical: '/four-insurances' },
...
const GUIDE = [
  { h: '4대보험이란?', p: ['4대보험은 국민연금, 건강보험, 고용보험, 산재보험입니다. 이 도구는 근로자 급여 공제액을 계산하므로 전액 사업주 부담인 산재보험은 제외하고, 건강보험에 부가되는 장기요양보험료를 함께 계산합니다.'] },
  { h: '요율 (근로자 부담)', p: ['국민연금 4.75%, 건강보험 3.595%, 장기요양보험은 건강보험료의 13.14%, 고용보험 0.9%입니다. 국민연금과 건강보험은 사업주도 같은 비율을 부담하고, 고용보험은 사업주가 조금 더 냅니다(고용안정·직업능력개발 부담).'] },
