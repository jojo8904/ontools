...
export const TOOLS: ToolMeta[] = [
  ...
  { href: '/ideal-weight', label: '적정체중 계산기', category: 'health', keywords: ['표준체중', '정상체중', '비만도'] },
  { href: '/sleep', label: '수면 시간 계산기', category: 'health', keywords: ['취침시간', '기상시간', '수면주기', '꿀잠'] },
  { href: '/alcohol', label: '음주 알코올 분해 계산기', category: 'health', keywords: ['술 깨는 시간', '혈중알코올', '위드마크', '음주운전'] },
  ...
  // 생활·유틸 (신규)
  { href: '/age', label: '만 나이 계산기', category: 'utility', keywords: ['나이', '만나이', '연령'] },
  { href: '/pyeong', label: '평수 ↔ ㎡ 변환기', category: 'utility', keywords: ['평', '제곱미터', '면적'] },
  { href: '/hourly-wage', label: '시급 ↔ 월급 환산기', category: 'salary-tax', keywords: ['시급', '월급', '연봉환산'] },
  { href: '/discount', label: '할인율 계산기', category: 'utility', keywords: ['할인', '세일', '퍼센트'] },
  { href: '/brokerage-fee', label: '부동산 중개수수료 계산기', category: 'finance', keywords: ['복비', '중개보수', '부동산'] },

  // 추가 배치
  { href: '/four-insurances', label: '4대보험 계산기', category: 'salary-tax', keywords: ['국민연금', '건강보험', '고용보험', '4대보험'] },
  { href: '/car-tax', label: '자동차세 계산기', category: 'finance', keywords: ['자동차세', '차량세금', '배기량', '연납'] },
  { href: '/gift-tax', label: '증여세 계산기', category: 'finance', keywords: ['증여세', '증여', '자녀증여', '증여공제'] },
  { href: '/compound-interest', label: '복리 계산기', category: 'finance', keywords: ['복리', '복리이자', '투자', '72의법칙'] },
  { href: '/date-calc', label: '날짜 계산기', category: 'utility', keywords: ['날짜계산', '며칠후', '일수'] },
  ...
  { href: '/id-photo', label: '증명사진 만들기', category: 'image', keywords: ['증명사진', '여권사진', '반명함', '증명사진규격', '비자사진'] },
  { href: '/heic-to-jpg', label: 'HEIC → JPG 변환', category: 'image', keywords: ['heic변환', 'heic jpg', '아이폰사진변환', 'heif', 'heic안열림'] },
  { href: '/image-to-pdf', label: '이미지 PDF 변환', category: 'image', keywords: ['이미지pdf', '사진pdf', 'jpg pdf', '사진여러장pdf', 'pdf만들기'] },
  { href: '/text-image', label: '텍스트 이미지 생성기', category: 'image', keywords: ['명언이미지', '글귀이미지', '코드이미지', '카드뉴스', '텍스트이미지'] },
  { href: '/watermark', label: '워터마크 넣기', category: 'image', keywords: ['워터마크', '사진워터마크', '로고삽입', '저작권표시', '도용방지'] },
  { href: '/bg-remove', label: '배경 제거 (누끼)', category: 'image', keywords: ['배경제거', '누끼따기', '사진배경지우기', '배경투명', '투명배경만들기'] },
  { href: '/image-resize', label: '이미지 크기 조절', category: 'image', keywords: ['이미지크기조절', '사진크기변경', '리사이즈', '사진px변경', '해상도변경'] },
  { href: '/image-convert', label: '이미지 형식 변환', category: 'image', keywords: ['webp jpg 변환', 'png jpg 변환', '이미지형식변환', 'webp안열림', 'webp변환'] },
  { href: '/pdf-to-image', label: 'PDF를 이미지로', category: 'image', keywords: ['pdf 이미지 변환', 'pdf jpg', 'pdf png', 'pdf그림으로', 'pdf사진변환'] },
  { href: '/image-crop', label: '이미지 자르기', category: 'image', keywords: ['사진자르기', '이미지크롭', '인스타정사각', '썸네일크기', '사진비율자르기'] },
  ...
  { href: '/pdf-merge', label: 'PDF 합치기·분할', category: 'image', badge: 'NEW', keywords: ['pdf합치기', 'pdf병합', 'pdf분할', 'pdf나누기', 'pdf페이지추출'] },
  { href: '/gif-maker', label: 'GIF 만들기 (움짤)', category: 'image', badge: 'NEW', keywords: ['gif만들기', '움짤만들기', '움짤제작', '사진gif', 'gif제작'] },

  // 생활·유틸 (2차 신규)
  { href: '/ladder', label: '사다리타기', category: 'utility', badge: 'NEW', keywords: ['사다리', '사다리게임', '제비뽑기', '내기', '랜덤뽑기'] },
  { href: '/kor-eng', label: '한/영타 변환기', category: 'utility', badge: 'NEW', keywords: ['한영타', '한영변환', 'dkssud', '영타한글', '오타변환'] },
  { href: '/special-chars', label: '특수문자 모음', category: 'utility', keywords: ['특수문자', '특수기호', '별문자', '하트문자', '원문자'] },
  { href: '/gpa', label: '학점 계산기', category: 'utility', keywords: ['학점', 'gpa', '평점', '학점계산', '4.5만점'] },
  { href: '/lunar', label: '음력 ↔ 양력 변환기', category: 'utility', keywords: ['음력변환', '양력음력', '음력생일', '윤달', '음양력'] },
  { href: '/annual-leave-days', label: '연차 개수 계산기', category: 'salary-tax', badge: 'NEW', keywords: ['연차개수', '연차계산', '입사일연차', '연차발생', '내연차'] },
]
